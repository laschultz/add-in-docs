...
<Resources>
  ...
  <bt:ShortStrings>
    <bt:String id="groupLabel" DefaultValue="Add-in Demo">
      <bt:Override Locale="ar-sa" Value="Ø¹Ø±Ø¶ Ø§Ù„ÙˆØ¸ÙŠÙØ© Ø§Ù„Ø¥Ø¶Ø§ÙÙŠØ©" />
    </bt:String>
    <!-- Other short strings -->
  </bt:ShortStrings>
  <bt:LongStrings>
    <bt:String id="funcReadSuperTipDescription" DefaultValue="Gets the subject of the message or appointment.">
      <bt:Override Locale="ar-sa" Value="ÙŠØ­ØµÙ„ Ø¹Ù„Ù‰ Ù…ÙˆØ¶ÙˆØ¹ Ø§Ù„Ø±Ø³Ø§Ù„Ø© Ø£Ùˆ Ø§Ù„ØªØ¹ÙŠÙŠÙ†." />
    </bt:String>
    <!-- Other long strings -->
  </bt:LongStrings>
</Resources>

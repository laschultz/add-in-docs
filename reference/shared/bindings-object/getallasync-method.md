...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../reference/shared/asyncresult/value-property.md)|Access an array that contains each binding created for the referenced [Bindings](../reference/shared/bindings-object/bindings-object.md) object|

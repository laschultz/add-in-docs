...
|:-----|:-----|:-----|:-----|
| _id_|**string**|Specifies the unique name of the binding to remove. Required.||
...
In the callback function passed to the  **releaseByIdAsync** method, you can use the properties of the **AsyncResult** object to return the following information.



|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../reference/shared/asyncresult/value-property.md)|Always returns  **undefined** because there is no data or object to retrieve.|

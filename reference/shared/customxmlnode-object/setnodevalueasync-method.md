...
|:-----|:-----|:-----|:-----|
| _value_|**string**|The value to set the current node to. Required.||
...
In the callback function passed to the  **setNodeValueAsync** method, you can use the properties of the **AsyncResult** object to return the following information.

...
|:-----|:-----|:-----|:-----|
| _ns_|**string**|Specifies the namespace to get the prefix for. Required.||
...
In the callback function passed to the  **getPrefixAsync** method, you can use the properties of the **AsyncResult** object to return the following information.



|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../reference/shared/asyncresult/value-property.md)|Access to a  **string** that contains the prefix of the specified namespace.|

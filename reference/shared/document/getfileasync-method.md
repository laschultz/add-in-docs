...
|**[Last changed](#bk_history) in File**|1.1|
...
|:-----|:-----|:-----|:-----|
| _fileType_|[FileType](../reference/enumerations/filetype-enumeration.md)|Specifies the format in which the file will be returned. Required.
...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](../reference/shared/asyncresult/value-property.md)|Access the [File](../reference/shared/file/file-object.md) object.|
